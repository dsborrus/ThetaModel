...
n1 = 800;   % number of neurons in the first population
n2 = 0;     % number of neurons in the second population
dt = 0.1;   % time step
tnum = 1e4; % the nummber of time steps
iu1 = 0.005;  % mean I parameter for first population
isig1 = 0.0001;  % std of I parameter for first population
...
D=0.15;      % Strength of networkness
...
Gradeit = 0; % Use fft to grade the output (NetVolAnalysis)
