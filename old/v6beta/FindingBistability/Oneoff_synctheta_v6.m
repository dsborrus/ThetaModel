...
dt = 0.5;   % time step
tmax = 3e4;     % maximum time of simulation
iu1 = -0.025;  % mean I parameter for first population
isig1 = 0.01951;  % std of I parameter for first population
iu2 = 1e-5;  % mean I parameter for second population (1e-5, once per second)
...
time2settle = 6e3; % time we think system takes to get to steady state
