function synctheta_v8(tmax,istate)
%
...
mgain = .1; % How much of an affect firing has on synaptic depression
taum  =  400; % Char time for return to ss for y (synap depress)
