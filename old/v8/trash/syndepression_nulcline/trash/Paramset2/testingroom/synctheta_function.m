...
%
% % % % Update History % % % %
function [yss,sps,yss_tarray,sps_tarray,spikes,raster,t] = synctheta_function(D,ydrop,tmax,tauy,istate,bumpit,n1,n2,iu1,iu2,isig1,isig2,plotit)
...
figure('Position',[100 500 1300 800])
...
sps_tarray = zeros(tmax,1);
for i = 1:tmax-1; sps_tarray(i) = sum(spf(i/dt:(i+1)/dt)); end
...
yss_tarray = zeros(tmax,1);
for i = 1:tmax-1; yss_tarray(i) = mean(mean(y(i/dt:(i+1)/dt,:))); end
