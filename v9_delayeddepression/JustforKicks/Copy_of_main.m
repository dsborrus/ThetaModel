...
% System params %
Parameters.tmax     = 30e3;     % maximum time of simulation
Parameters.dt       = 0.2;     % time step

% Neurons params %

Parameters.iu1      = -0.002; % mean I parameter for first population
Parameters.isig1    = 0.000;     % std of I parameter for first population
