function DBPlot_v2(dt,tmax,t,n,y,sij,spikes,raster,rr,Ihistory,sijhistory,vin,tauavg,istate)
...
fig = figure('Position',[800 500 1500 800]);
...
str = ['istate = ' mat2str(istate)];
annotation('textbox',[.1 .05 .1 .1],'String',str,'FitBoxToText','on');

axis off

saveas(fig,['sweep1/dataset' mat2str(length(dir('sweep1/*.png'))+1) '.png'])
