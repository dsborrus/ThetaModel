...
This should be version 9. You can tell because the folder (directory) is 'ThetaModel/v9' . Is this correct?

In this directory (v9/) there should be:
...
For new users, try opening JustRunSim. This is the sandbox folder.
...
All experiment folders have a main.m file, and they all call the same simulation function, that is v9/simulate_v9.m.


The .m files:
The main.m file is the file to run. It kicks off the simulation.
The simulate_v1.m file is the simulation itself.
The plot*.m files are functions to plot the results. If you are interested in making new plots, you can edit this script or write your own.
updategif.m is another figure making file. It was for making a gif!


To run:
Open JustRunSim/main.m
hit Run
...
The latex document describing this model can be found on sharelatex at 
https://www.overleaf.com/5474383159wqcvvxsdqnhb
