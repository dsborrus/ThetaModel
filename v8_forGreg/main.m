...
% This version is for Greg 190715
...
Parameters.istate   = 3;       % the initial state (1-low, 2- high, 3- random, 4-last state)
Options.conmat      = 1;       % which type of network to make
    % case 1 - ER
...
Options.Doablate    = 0;        % binary, do the ablation?
