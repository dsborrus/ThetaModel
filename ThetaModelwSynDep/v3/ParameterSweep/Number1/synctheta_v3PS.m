...
function [sps] = synctheta_v3PS(D,ydrop,tauy,iu1,isig1,istate,bumpit,DoDBPlot,tmax)
% D is strength of pulse
% ydrop is the drop of synaptic depression after a spike
% tauy is the recovery of synaptic depression
% iu1 is the mean I for neurons
% isig1 is the std of the neurons
% tmax is maximum time for simulation

% istate is the initial state of the system
% it is a switch, value should be 1 for low state initial conditions
% 2 for high state initial conditions
%
% bumpit is a conditional for a network stimulation at t = 250
dur = 30; % seconds

% doDBplots, should this make plots? 1 = yes, 0 = no
